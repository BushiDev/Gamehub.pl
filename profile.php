<?php
    ...
    if($connection->connect_errno == 0){
        ...
        $sql = 'SELECT id, show_name, avatar, color FROM users WHERE show_name = "'.$_GET['name'].'";';
        if($result = $connection->query($sql)){
            ...
            if($result->num_rows == 1){
                ...
                header("Location: error.php?code=2137");

            }
            
        }else{

            header("Location: error.php?code=666");
    
        }

    }else{

        header("Location: error.php?code=69");
...
<!DOCTYPE html>
<html lang="pl" style="--secondary-color: <?php echo $user_data['color'] ?>">
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Gamehub - Konto <?php echo $user_data['show_name']; ?></title>
...
<body>
    ...
    <main class="account">
        ...
        <?php 
            ...
            $html = '<img src="images/avatars/'.$user_data['avatar'].'.png" id="player_avatar">';
        
            echo $html; 
        
        ?>

        <h1 id="player_welcome"><?php echo $user_data['show_name']; ?>!</h1>


        <article class="achievements">
        
            <h1>Ostatnie osiągnięcia</h1>
            ...
            <?php
                ...
                if($connection->connect_errno == 0){
                    ...
                    $sql = 'SELECT * FROM collected_achievements INNER JOIN achievements ON `collected_achievements`.`achievement_id` = `achievements`.`id` AND `collected_achievements`.`user_id` = '.$user_data['id'].' ORDER BY `collected_achievements`.`id` DESC';

                    if($result = $connection->query($sql)){

                        if($result->num_rows == 0){

                            echo "<h2>Ten gracz, nie zdobył jeszcze żadnych osiągnięć</h2>";
        ...
        <article class="scoreboards">
            ...
            <h2>Statystyki <?php echo $user_data['show_name']; ?></h2>
            <div id="pong_scores">
                ...
                <?php
                    ...
                    $sql = 'SELECT * FROM pong_scoreboard WHERE player_id = '.$user_data['id'];
            ...
            <div id="snake_scores">
                ...
                <?php
                    ...
                    $sql = 'SELECT * FROM snake_scoreboard WHERE player_id = '.$user_data['id'];
            ...
            <div id="tic_tac_toe_scores">
                ...
                <?php
                    ...
                    $sql = 'SELECT * FROM tic_tac_toe_scoreboard WHERE player_id = '.$user_data['id'];
